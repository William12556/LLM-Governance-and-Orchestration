...
- Add ISO 690 references (Harvard style) and citations at the end of all newly created documents if external sources of information are used (e.g., web sites).
